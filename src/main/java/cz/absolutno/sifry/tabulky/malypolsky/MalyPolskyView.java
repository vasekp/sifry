...
public final class MalyPolskyView extends AidView {
	...
	public void onDraw(Canvas c) {
		...
		for(int x = -1; x <= 1; x++)
			for(int y = -1; y <= 1; y++) {
				if(x >= 0) c.drawLine(w/4 + sx*x - .5f*sx + 1.5f*wd, h/4 + sy*y - .5f*sy + 1.5f*wd,
						w/4 + sx*x - .5f*sx + 1.5f*wd, h/4 + sy*y + .5f*sy - 1.5f*wd, pLine);
				if(x <= 0) c.drawLine(w/4 + sx*x + .5f*sx - 1.5f*wd, h/4 + sy*y - .5f*sy + 1.5f*wd,
						w/4 + sx*x + .5f*sx - 1.5f*wd, h/4 + sy*y + .5f*sy - 1.5f*wd, pLine);
				if(y >= 0) c.drawLine(w/4 + sx*x - .5f*sx + 1.5f*wd, h/4 + sy*y - .5f*sy + 1.5f*wd,
						w/4 + sx*x + .5f*sx - 1.5f*wd, h/4 + sy*y - .5f*sy + 1.5f*wd, pLine);
				if(y <= 0) c.drawLine(w/4 + sx*x - .5f*sx + 1.5f*wd, h/4 + sy*y + .5f*sy - 1.5f*wd,
						w/4 + sx*x + .5f*sx - 1.5f*wd, h/4 + sy*y + .5f*sy - 1.5f*wd, pLine);
			}
		...
		for(int x = -1; x <= 1; x++)
			for(int y = -1; y <= 1; y++) {
				if(x >= 0) c.drawLine(3*w/4 + sx*x - .5f*sx + 1.5f*wd, h/4 + sy*y - .5f*sy + 1.5f*wd,
						3*w/4 + sx*x - .5f*sx + 1.5f*wd, h/4 + sy*y + .5f*sy - 1.5f*wd, pLine);
				if(x <= 0) c.drawLine(3*w/4 + sx*x + .5f*sx - 1.5f*wd, h/4 + sy*y - .5f*sy + 1.5f*wd,
						3*w/4 + sx*x + .5f*sx - 1.5f*wd, h/4 + sy*y + .5f*sy - 1.5f*wd, pLine);
				if(y >= 0) c.drawLine(3*w/4 + sx*x - .5f*sx + 1.5f*wd, h/4 + sy*y - .5f*sy + 1.5f*wd,
						3*w/4 + sx*x + .5f*sx - 1.5f*wd, h/4 + sy*y - .5f*sy + 1.5f*wd, pLine);
				if(y <= 0) c.drawLine(3*w/4 + sx*x - .5f*sx + 1.5f*wd, h/4 + sy*y + .5f*sy - 1.5f*wd,
						3*w/4 + sx*x + .5f*sx - 1.5f*wd, h/4 + sy*y + .5f*sy - 1.5f*wd, pLine);
