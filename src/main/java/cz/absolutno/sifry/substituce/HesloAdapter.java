	...
	public String getItem(int position) {
		...
		while((oa = spa.getNextOrd()) != StringParser.EOF) {
			...
			if((ob = spb.getNextOrd()) < 0) {
				switch(position) {
				case BAPLUS0: case BAMINUS0: case BAMINUSR0:
				case BAPLUS1: case BAMINUS1: case BAMINUSR1:
					spb = abc.getStringParser(strProc);
					break;
				case BVPLUS0: case BVMINUS0: case BVMINUSR0:
				case BVPLUS1: case BVMINUS1: case BVMINUSR1:
			...
			int c;
			switch(position) {
			case PLUS0: case BAPLUS0: case BVPLUS0:
				c = oa + ob;
				break;
			case MINUS0: case BAMINUS0: case BVMINUS0:
				c = oa - ob;
				break;
			case MINUSR0: case BAMINUSR0: case BVMINUSR0:
				c = ob - oa;
				break;
			case PLUS1: case BAPLUS1: case BVPLUS1:
				c = oa + ob + 1;
				break;
			case MINUS1: case BAMINUS1: case BVMINUS1:
				c = oa - ob - 1;
				break;
			case MINUSR1: case BAMINUSR1: case BVMINUSR1:
				c = ob - oa - 1;
				break;
			case SKOK1:
				c = 2*oa - ob;
