...
public final class AutokeyAdapter extends AbstractSubstAdapter {
	...
	public String getItem(int position) {
		...
		while((o = sp.getNextOrd()) != StringParser.EOF) {
			...
			switch(position) {
			case PLUSPR1: case MINUSPR1: case PRMINUS1:
			case PLUSRUN1: case MINUSRUN1: case RUNMINUS1:
				o++;
				break;
			}
			switch(position) {
			case PLUSPR0: case MINUSPR0: case PRMINUS0:
			case PLUSPR1: case MINUSPR1: case PRMINUS1:
			case SKOK:
				r = l; l = o;
			}
			if(!prvni) {
				...
				case SKOK: 
					o = 2*o - r;
					break;
				case PLUSPR0: case PLUSPR1: case PLUSRUN0: case PLUSRUN1:
					o += r;
					break;
				case MINUSPR0: case MINUSPR1: case MINUSRUN0: case MINUSRUN1:
					o -= r;
					break;
				case PRMINUS0: case PRMINUS1: case RUNMINUS0: case RUNMINUS1:
					o = r-o;
					break;
				}
			}
			...
			o %= abc.count();
			switch(position) {
			case PLUSRUN0: case MINUSRUN0: case RUNMINUS0:
			case PLUSRUN1: case MINUSRUN1: case RUNMINUS1:
				r = o;
			}
			switch(position) {
